...
const addTask = async (req, res) => {
  ...
  const tasks = [parseInt(taskOne), parseInt(taskTwo), parseInt(taskThree)];
...
const editScore = async (req, res) => {
  ...
  const taskOne = req.body.taskOne;
  const taskTwo = req.body.taskTwo;
  const taskThree = req.body.taskThree;
